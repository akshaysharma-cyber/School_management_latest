...
const NAV_ITEMS = [
  ...
  { id: "reports", label: "Reports", icon: <ReportsIcon />, hasChildren: true },
              ...
              {item.hasChildren && expandedMenu === item.id && (
                ...
                <div style={{ marginLeft: 20, marginBottom: 4 }}>
                  ...
                  {item.id === "reports" && [
                    ...
                    { id: "admissionReport", label: "Admission Report" },
                    { id: "feeCollection", label: "Fee Collection" },
                    { id: "pendingFees", label: "Pending Fees" },
                    { id: "studentAttendance", label: "Student Attendance" },
                    { id: "teacherAttendance", label: "Teacher Attendance" },
                    { id: "marksReport", label: "Marks Report" },
                    { id: "marksheet", label: "Marksheet" },
                    { id: "resultReport", label: "Result Report" },
                    { id: "teacherList", label: "Teacher List" }
                    ...
                    <div
                      ...
                      style={{
                        padding: "7px 16px",
                        fontSize: 13,
                        fontWeight: subPage === sub.id ? 700 : 500,
                        color: subPage === sub.id ? "#4361ee" : "#8898b8",
                        cursor: "pointer",
                        borderRadius: 8,
                        background: subPage === sub.id ? "#f0f4ff" : "transparent",
                        margin: "1px 0"
                      }}
                    >
                      {sub.label}
      ...
      <div style={{ flex: 1, display: "flex", flexDirection: "column", minWidth: 0 }}>
        ...
        <Box
          sx={{
            ...
            boxShadow: "0 1px 8px rgba(67,97,238,0.05)"
          }}
        >
        ...
        >
          ...
          {activePage === "reports" && subPage === "studentList" && (
            <StudentListReportPage onBack={() => setSubPage(null)} />
          )}

          {activePage === "reports" && subPage === "admissionReport" && (
            <AdmissionReportPage onBack={() => setSubPage(null)} />
          )}

          {activePage === "reports" && subPage === "feeCollection" && (
            <FeeCollectionReportPage onBack={() => setSubPage(null)} />
          )}

          {activePage === "reports" && subPage === "pendingFees" && (
            <PendingFeeReportPage onBack={() => setSubPage(null)} />
          )}

          {activePage === "reports" && subPage === "studentAttendance" && (
            <StudentAttendanceReportPage onBack={() => setSubPage(null)} />
          )}

          {activePage === "reports" && subPage === "teacherAttendance" && (
            <TeacherAttendanceReportPage onBack={() => setSubPage(null)} />
          )}

          {activePage === "reports" && subPage === "marksReport" && (
            <MarksReportPage onBack={() => setSubPage(null)} />
          )}

          {activePage === "reports" && subPage === "marksheet" && (
            <MarksheetPage onBack={() => setSubPage(null)} />
          )}

          {activePage === "reports" && subPage === "resultReport" && (
            <ResultReportPage onBack={() => setSubPage(null)} />
          )}

          {activePage === "reports" && subPage === "teacherList" && (
